...
- سوال‌های کمتر هنگام ساخت: پورت WireGuard، AllowedIPs، ذخیره کانفیگ و فعال‌سازی سرویس به‌صورت خودکار انجام می‌شود
...
اگر public key طرف مقابل را خالی بگذارید، اسکریپت فقط key همین سرور را می‌سازد و public key را نشان می‌دهد؛ سرویس WireGuard را شروع نمی‌کند تا کانفیگ خراب ساخته نشود.
