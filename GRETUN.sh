...
# GRE + WireGuard + TCP multi-tunnel manager v13
...
# - v13 fixes TCP/OpenVPN startup checks, avoids fragile server IP binding, and adds clearer diagnostics
...
tcptun_write_openvpn_config() {
  ...
  cat > "$conf" <<EOF_CONF
# Generated by gretun-manager v13
